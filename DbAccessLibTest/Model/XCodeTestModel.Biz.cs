...
{
    /// <summary></summary>
    public partial class XCodeTestModel : Entity<XCodeTestModel>
    {
        #region 扩展属性﻿
        #endregion
        ...
        public static XCodeTestModel FindByKeyForEdit(String guid)
        {
            XCodeTestModel entity = Find(new String[] { _.Guid }, new Object[] { guid });
            if (entity == null)
            {
                entity = new XCodeTestModel();
            }
            return entity;
        }
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static XCodeTestModel FindByGuid(String guid)
        {
            if (Meta.Count >= 1000)
        ...
        //public static EntityList<Test> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
